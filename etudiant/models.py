...
class Inscriptiondiplome(models.Model):
    ...
    rangAnnee=models.IntegerField(null=True,blank = True)
    statutDipl = models.CharField(null=True,blank = True,choices=Statut.choices, max_length=6,default =None)
    datedecisionDipl = models.DateTimeField(null=True,blank = True,default=None)
    statutS1 = models.CharField(null=True,blank = True,choices=Statut.choices, max_length=6,default =None)
    datedecisionS1 = models.DateTimeField(null=True,blank = True,default=None)
    statutS2 = models.CharField(null =True,blank = True,choices=Statut.choices, max_length=6,default =None)
    datedecisionS2 = models.DateTimeField(null=True,blank = True,default=None)
...
class Inscriptionmat(models.Model):
    ...
    notecc1=models.FloatField(null=True,blank=True)
    notecc2=models.FloatField(null=True,blank=True)
    notecc3=models.FloatField(null=True,blank=True)
    moyenne=models.FloatField(null=True,blank=True)
    pointjury=models.FloatField(null=True,blank=True)
    statut = models.CharField(null = True,blank=True,choices=Statut.choices, max_length=6)
    decisionmat = models.DateTimeField(null=True,blank=True,)
